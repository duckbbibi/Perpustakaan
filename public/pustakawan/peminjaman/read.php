...
if(isset($_POST["addPeminjaman"])){
    ...
    $catatan = "$level $adminInfo telah menambahkan peminjaman baru dengan ID Peminjaman: $idpeminjamanterakhir";
...
<div class="p-4 col-md-5 w-100 mt-auto mb-auto">
  ...
  <form method="post" enctype="multipart/form-data">
          ...
          <label for="">Admin</label><br>
            <input class="form-control mb-3" type="hidden" name="f_idadmin" value="<?php echo $id; ?>">
            <input class="form-control mb-3" type="text" value="<?= $_SESSION['pustakawan'] ?>" readonly style="cursor: no-drop;">
          </div>
